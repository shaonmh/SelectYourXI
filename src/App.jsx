...
function App() {
  ...
  const playerToShow = activeTab === "available" ? players : select;

  const availableText = "Available Players";
  const selectText = `Selected Players  (${select.length} /6)`;

  const tabText = activeTab === "available" ? availableText : selectText;
        ...
        <div className="available w-5/6 mx-auto flex justify-between mt-15">
          ...
          <div className="select">
            ...
            <button
              ...
              className={`rounded-l-none rounded-lg border-gray-300 border-2 hover:bg-lime-300 focus:border-transparent focus:ring-0  ${
                activeTab === "selected"
                  ? "bg-lime-300 text-gray-800"
                  : "bg-white"
              }`}
        ...
        <div className="flex profile-container w-5/6 mx-auto mt-20 mb-30 pb-80">
          {
            ...
            activeTab === "available" ? (
              ...
              <ul className="w-full flex flex-col gap-5 ">
                ...
                <button
                  className="bg-orange-200 w-50 px-4 py-3 rounded-xl"
                  onClick={() => handleTabChange("available")}
                >
                  Add more player
                </button>
          ...
          <div className="footer-content grid grid-cols-3 gap-20 my-30">
            ...
            <div className="sub-container">
              ...
              <div className="sub flex items-center my-5">
                <input
                  type="text"
                  className="h-10 appearance-none leading-2.5 bg-amber-50 rounded-r-none rounded-xl w-2/3 text-xs  px-4  py-2  text-gray-700 focus:outline-none focus:shadow-outline"
                  placeholder="Enter your email"
                />
                <a
                  href="#"
