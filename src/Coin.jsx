...
const Coin = ({setCoins}) => {
    ...
    <div className="banner relative overflow-hidden rounded-2xl w-5/6 mx-auto  h-130 ]" >
        <div className="absolute bg-black inset-0" style={{ backgroundColor: 'black' }}>
            <div className='absolute inset-0 bg-cover bg-center ' style={{ backgroundImage: "url('/assets/bg-shadow.png')" }}>
              <div className=" flex flex-col justify-center items-center">
                <img className='w-55 mt-15' src="/assets/banner-main.png" alt="banner" />
